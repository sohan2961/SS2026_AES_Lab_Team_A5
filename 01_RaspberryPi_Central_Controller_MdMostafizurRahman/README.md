...
| `greenhouse/actuator/relay/set` | Publish | Relay ON/OFF command to Arduino |
...
| Send test temperature message | `mosquitto_pub -h localhost -t greenhouse/temperature -m "25.0"` |
| Send relay ON command | `mosquitto_pub -h localhost -t greenhouse/actuator/relay/set -m "ON"` |
| Send relay OFF command | `mosquitto_pub -h localhost -t greenhouse/actuator/relay/set -m "OFF"` |
...
| MQTT broker address (for ESP32/Arduino sketches) | `172.20.10.4` |
